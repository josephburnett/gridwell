...
type InfoResponse struct {
	...
	// menu_entries: the plugin's declared (+) menu additions, stamped by
	// the node onto every grid it serves for this plugin (the #258
...
// media_type; plugin content is not version-edited (versions are a
// node fact).
...
// leaves the old value intact. Plugins that are pure projections
...
// Delete asks the plugin to delete the SOURCE thing behind an entry
