...
// (tmux-style named rectangles, outermost first), the focused pane's
// descent chain (square tile previews, root inclusive — issue #212), and
// the circle slot. Pure Go (no js): render and input read
