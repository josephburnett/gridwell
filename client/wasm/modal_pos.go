...
// the screen. The ONE centering rule for every modal card (url, schema,
// picker): the geometry decision lives in panebox.ModalCardPos; this
// function only measures and applies styles.
//
